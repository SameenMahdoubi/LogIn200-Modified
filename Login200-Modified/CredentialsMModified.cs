...
{
    public class CredentialsMModified
    {
        /// <summary>
        ...
        public CredentialsMModified(String un, String up)
        {
            Uname = un;
            Password = up;
        }
        ...
        /// <returns>Returns true if the user name and password match the credentials, 
